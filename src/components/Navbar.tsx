    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex items-center justify-between">
        <button
          ...
          className={`font-serif text-lg tracking-wide-sm transition-colors duration-500 ${
          ...
          {navLinks.map((link) => (
            <button
              ...
              className={`nav-link text-xs tracking-wide-sm font-light transition-colors duration-500 ${
                scrolled ? 'text-ink-700 hover:text-ink-900' : 'text-paper-200 hover:text-paper-50'
        ...
        <button
          className={`md:hidden transition-colors duration-500 ${scrolled ? 'text-ink-900' : 'text-paper-100'}`}
